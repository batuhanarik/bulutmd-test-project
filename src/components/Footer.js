const Footer = () => {
  return (
    <footer className="flex flex-col w-full bottom-0 fixed p-3 bg-neutral text-neutral-content">
      <div className="inline-block mx-7 max-sm:text-sm max-sm:mx-5 max-sm:text-center">
